...
abstract class AbstractPreAuthenticationProvider {
	...
	public function testUser( $user, $reqs ) {
		return;
	}
...
include_once $argv[1];
$creds = [ 'wgDBuser' => $wgDBuser, 'wgDBpassword' => $wgDBpassword ];
$json_output = json_encode($creds);
